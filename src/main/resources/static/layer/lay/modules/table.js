...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    I.prototype.config = {
        ...
        var e = this, a = e.config,
            l = ['<span class="layui-btn layui-btn-sm" lay-event="add">添加</i></span>', '<span class="layui-btn layui-btn-sm" lay-event="update">修改</span>', '<div class="layui-btn layui-btn-danger layui-btn-sm" lay-event="delete">删除</div>'].join(""),
        ...
        return d.cache[c.key] = y, c.layPage[0 == o || 0 === y.length && 1 == n ? "addClass" : "removeClass"](f), r ? g() : 0 === y.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed.removeClass(f), g(), c.renderTotal(y), void (s.page && (s.page = t.extend({
            ...
            count: o,
            limit: s.limit,
            limits: s.limits || [10, 20, 30, 50,100,100000],
            groups: 3,
            ...
            t.eachCols(function (e, t) {
                var n = t.field || e,
                    o = ['<td data-field="' + n + '" data-key="' + i.index + "-" + t.key + '" ' + function () {
                        ...
                        return t.totalRow ? parseFloat(a[n]).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') || e : e
                    }(), "</div></td>"].join("");
                l.push(o)
