...
!function (e, t, n) {
    ...
    function s(e, t) {
        if ("object" == typeof e) for (var n in e) P(e, n) && s(n, e[n]); else {
            e = e.toLowerCase();
    ...
    var w = [], S = t.documentElement, x = "svg" === S.nodeName.toLowerCase(), _ = "Moz O ms Webkit",
    ...
    Modernizr.addTest("customelements", "customElements" in e), Modernizr.addTest("history", function () {
        ...
        var t = a("canvas"), n = "probablySupportsContext" in t ? "probablySupportsContext" : "supportsContext";
...
(function (e, t) {
    ...
    function q(e, t) {
        var o = e.offsets, n = o.popper, i = o.reference, r = -1 !== ['left', 'right'].indexOf(e.placement),
            p = -1 !== e.placement.indexOf('-'), s = i.width % 2 == n.width % 2,
            d = 1 == i.width % 2 && 1 == n.width % 2, a = function (e) {
                return e
            }, l = t ? r || p || s ? $ : Z : a, f = t ? $ : a;
